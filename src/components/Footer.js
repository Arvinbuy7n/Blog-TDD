...
export const Footer = () => {
  return (
    <div className="md:flex flex-col w-full md:py-20 md:px-52 gap-8 py-14 bg-slate-100">
      <div className="md:flex md:gap-10 md:ml-20 md:border-none border-t-2">
        ...
        <div className="flex flex-col gap-2 px-44 md:mt-0 mt-12">
          <Link href="/">
            <p className="text-slate-500 text-sm hover:bg-blue-700 rounded-lg hover:text-white px-4 text-center">
              Home
            </p>
          </Link>
          <Link href="/ablog">
            <p className="text-slate-500 text-sm hover:bg-purple-700 rounded-lg hover:text-white px-4 text-center">
              Blog
            </p>
          </Link>
          <Link href="/contact">
            <p className="text-slate-500 text-sm hover:bg-cyan-400 rounded-lg hover:text-black px-4 text-center">
              Contact
            </p>
          </Link>
        </div>
